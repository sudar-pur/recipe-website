const recipes = [
...

  {
    ...
    story: "Rajma chawal, kidney beans and rice, is peak comfort food. It's the kind of meal you eat in a bowl on the couch and immediately feel better about everything. The thick, spiced gravy with soft beans over hot rice is one of those combinations that just works on every level.\n\nA standard version gives you about 10-12g protein per serving, which is fine for a side dish but not enough when it's your main meal after training. I loaded up on the beans, three cans, and mash some against the side of the pot to create this thick, stew-like consistency. A thick Greek yogurt raita on the side adds even more protein and a cool contrast to the warm spices.\n\nThis is serious meal prep material. I'll make a huge batch on the weekend and eat it over rice all week. The flavors develop and deepen overnight, so Monday's lunch is even better than Sunday's dinner. At 20g protein per serving, it pulls its weight without any fancy tricks.",
    proteinModification: "A classic rajma masala relies on kidney beans alone for protein, delivering about 10-12g per serving. We increased the bean quantity to three cans and built a thick Greek yogurt raita into every serving. From ~11g to 20g per serving, nearly double the protein, and it still tastes exactly like the rajma you grew up eating.",
    ingredients: [
      { amount: 3, unit: "cans (15oz)", item: "red kidney beans", note: "drained and rinsed", protein: 60 },
