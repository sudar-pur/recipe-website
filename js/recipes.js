const recipes = [
...

  {
    ...
    proteinModification: "Veggie enchiladas at most restaurants are cheese-and-sadness affairs with about 12-14g of protein. We overhauled the filling: doubled the black beans, added a full cup of cottage cheese (it disappears into the filling but adds major protein), increased the shredded cheese to 7oz, and topped with Greek yogurt instead of sour cream. The result is 35g of protein per serving. The cottage cheese trick is the secret weapon here — you'd never know it's there.",
    ingredients: [
...

  {
    ...
    story: "My mom's raita was always made with regular yogurt — thin, watery, and honestly kind of an afterthought on the plate. When I switched to Greek yogurt, it changed the whole game. It's thicker, tangier, and has roughly three times the protein.\n\nI eat this with pretty much every Indian meal now. It takes five minutes to throw together, it cools down spicy food, and it's basically free protein. Eight grams from a condiment? I'll take that every single time.",
