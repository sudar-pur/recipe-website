const recipes = [
...

  {
    ...
    carbsPerServing: 26,
    fiberPerServing: 6,
    description: "A hearty, spiced chickpea curry with a generous swirl of cottage cheese stirred in and finished with Greek yogurt. This isn't your standard chana masala, it's built to deliver real protein.",
    story: "Chickpeas are one of the most underrated protein sources out there. I used to eat chana masala just because it tasted good. It wasn't until I started tracking macros that I realized I'd been sitting on a goldmine. A regular version gets you about 10-12g protein per serving, which is decent, but not enough when you're trying to hit 35-40g per meal.\n\nSo I started tinkering. I stirred in cottage cheese directly into the curry. Sounds weird, but it melts right in and adds this creamy richness you'd never expect. A thick finish of Greek yogurt instead of cream seals the deal. Now it hits 16g per serving and honestly tastes better than the original.\n\nThis is one of my favorite meal prep recipes. I'll make a big batch on Sunday, portion it out, and it reheats perfectly all week. The flavors actually get better after a day in the fridge.",
    proteinModification: "Traditional chana masala relies on chickpeas alone for its protein, typically landing around 10-12g per serving. We stirred in a full cup of cottage cheese directly into the curry, plus a generous swirl of Greek yogurt at the end. The result is 16g per serving, a solid bump over the standard version.",
    ingredients: [
      { amount: 2, unit: "cans (15oz)", item: "chickpeas", note: "drained and rinsed", protein: 42 },
...

  {
    ...
    carbsPerServing: 32,
    fiberPerServing: 9,
    description: "Comforting kidney bean curry in a thick, spiced gravy, served with a built-in Greek yogurt raita. A protein-forward take on the ultimate North Indian comfort food.",
    story: "Rajma chawal, kidney beans and rice, is peak comfort food. It's the kind of meal you eat in a bowl on the couch and immediately feel better about everything. The thick, spiced gravy with soft beans over hot rice is one of those combinations that just works on every level.\n\nA standard version gives you about 10-12g protein per serving, which is fine for a side dish but not enough when it's your main meal after training. I mash some of the beans against the side of the pot to create this thick, stew-like consistency. A thick Greek yogurt raita on the side adds even more protein and a cool contrast to the warm spices.\n\nThis is serious meal prep material. I'll make a huge batch on the weekend and eat it over rice all week. The flavors develop and deepen overnight, so Monday's lunch is even better than Sunday's dinner. At 16g protein per serving, pair it with jeera rice and raita and you're at 30g for the meal.",
    proteinModification: "A classic rajma masala relies on kidney beans alone for protein, delivering about 10-12g per serving. We built a thick Greek yogurt raita into every serving, bumping it to 16g per serving. Pair with protein jeera rice and you're well over 20g for the meal.",
    ingredients: [
      { amount: 2, unit: "cans (15oz)", item: "red kidney beans", note: "drained and rinsed", protein: 40 },
...

  {
    ...
    ingredients: [
      ...
      { amount: 1.5, unit: "cups", item: "Mexican cheese blend", note: "shredded", protein: 36 },
...

  {
    ...
    carbsPerServing: 16,
    fiberPerServing: 2,
    description: "Indian-spiced scrambled eggs with cottage cheese folded in, served with a side of Greek yogurt. A 25g-protein breakfast that comes together in 10 minutes flat.",
    story: "Egg bhurji is what got me through early morning gym sessions in college. Fifteen minutes from pan to plate, and loaded with protein. If you can scramble eggs, you can make this. It's just scrambled eggs with way more going on in the flavor department.\n\nThe original version uses two eggs per serving, which gives you maybe 12g of protein. Fine for a light morning, but useless if you just did a heavy squat session. I pushed it to three eggs per serving and started stirring in cottage cheese during the last minute of cooking. The cottage cheese melts slightly into the eggs, creating these amazing pockets of richness that make it taste way more indulgent than it is.\n\nI make this almost every morning. Sometimes I wrap it in a roti, sometimes I eat it with toast, and sometimes I just eat it straight from the pan while standing in my kitchen at 6 AM before the gym. No judgment.",
    proteinModification: "Standard egg bhurji uses 2 eggs per serving and that's about it, roughly 12-14g of protein. We made two changes: increased to 3 eggs per serving (12 total) and folded in cottage cheese which softens in the heat and creates incredible richness. Always serve with a side of Greek yogurt. From ~13g to 25g, turning a light breakfast into a serious protein bomb.",
    ingredients: [
      { amount: 12, unit: "", item: "large eggs", protein: 72 },
    ...
    proteinTips: [
      ...
      "Increase to 4 eggs per serving for an extra 6g protein per serving."
    ],
    substitutions: [
